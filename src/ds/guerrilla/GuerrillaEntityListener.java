		...
		if (event instanceof EntityDamageByEntityEvent) {
			...
			if ((damagee instanceof Player) && (damager instanceof Player)){			
				...
				if ((damageechunkguerrilla != null) && (damageechunkguerrilla.equals(gpdamagee))) {
					if ((sub.getDamage()/Guerrilla.defbonus)==0) pdamager.sendMessage(ChatColor.DARK_RED + "[Guerrilla] " + ChatColor.GRAY + "Your weapon does nothing to " + pdamagee.getName() + " here!");
